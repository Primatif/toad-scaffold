...
new project directories with the correct structure, configuration files, and git
setup based on configurable templates.
...
- **Editor Integration** — `open_in_editor()` launches the newly created project
